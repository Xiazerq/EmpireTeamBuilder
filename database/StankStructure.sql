...
/*
This will contain all the Characters and the Attiribute ID
*/
//create table CharactersAttributes


/*
AttributeTypes.  This SHOULD be static..
*/
CREATE TABLE AttributeTypes 
	(
		AttTypId int AUTO_INCREMENT
		, AttTypName VARCHAR(50)
		, primary key (AttTypId)
	);


insert into AttributeTypes (AttTypName) values ('Alignment');
insert into AttributeTypes (AttTypName) values ('Categories');
insert into AttributeTypes (AttTypName) values ('AbilityClasses');
insert into AttributeTypes (AttTypName) values ('Role');


/*
The Attributes will have the Type and all the names.  The UID will be the FK in other tables.
*/
CREATE TABLE Attributes
	(
		AttribId int AUTO_INCREMENT
		, AttributeTypesAttTypId	int
		, AttribName VARCHAR(50)
...
/*
Counter Table used for udf_DelimitToArray
*/
...
insert into Counter (CounteID) values (1);
insert into Counter (CounteID) values (2);
insert into Counter (CounteID) values (3);
insert into Counter (CounteID) values (4);
insert into Counter (CounteID) values (5);
insert into Counter (CounteID) values (6);
insert into Counter (CounteID) values (7);
insert into Counter (CounteID) values (8);
insert into Counter (CounteID) values (9);
insert into Counter (CounteID) values (10);
insert into Counter (CounteID) values (11);
insert into Counter (CounteID) values (12);
insert into Counter (CounteID) values (13);
insert into Counter (CounteID) values (14);
insert into Counter (CounteID) values (15);
insert into Counter (CounteID) values (16);
insert into Counter (CounteID) values (17);
insert into Counter (CounteID) values (18);
insert into Counter (CounteID) values (19);
insert into Counter (CounteID) values (20);
insert into Counter (CounteID) values (21);
insert into Counter (CounteID) values (22);
insert into Counter (CounteID) values (23);
insert into Counter (CounteID) values (24);
insert into Counter (CounteID) values (25);
insert into Counter (CounteID) values (26);
insert into Counter (CounteID) values (27);
insert into Counter (CounteID) values (28);
insert into Counter (CounteID) values (29);
insert into Counter (CounteID) values (30);
insert into Counter (CounteID) values (31);
insert into Counter (CounteID) values (32);
insert into Counter (CounteID) values (33);
insert into Counter (CounteID) values (34);
insert into Counter (CounteID) values (35);
insert into Counter (CounteID) values (36);
insert into Counter (CounteID) values (37);
insert into Counter (CounteID) values (38);
insert into Counter (CounteID) values (39);
insert into Counter (CounteID) values (40);
insert into Counter (CounteID) values (41);
insert into Counter (CounteID) values (42);
insert into Counter (CounteID) values (43);
insert into Counter (CounteID) values (44);
insert into Counter (CounteID) values (45);
insert into Counter (CounteID) values (46);
insert into Counter (CounteID) values (47);
insert into Counter (CounteID) values (48);
insert into Counter (CounteID) values (49);
insert into Counter (CounteID) values (40);
insert into Counter (CounteID) values (51);
insert into Counter (CounteID) values (52);
insert into Counter (CounteID) values (53);
insert into Counter (CounteID) values (54);
insert into Counter (CounteID) values (55);
insert into Counter (CounteID) values (56);
insert into Counter (CounteID) values (57);
insert into Counter (CounteID) values (58);
insert into Counter (CounteID) values (59);
insert into Counter (CounteID) values (60);
insert into Counter (CounteID) values (61);
insert into Counter (CounteID) values (62);
insert into Counter (CounteID) values (63);
insert into Counter (CounteID) values (64);
insert into Counter (CounteID) values (65);
insert into Counter (CounteID) values (66);
insert into Counter (CounteID) values (67);
insert into Counter (CounteID) values (68);
insert into Counter (CounteID) values (69);
insert into Counter (CounteID) values (70);
insert into Counter (CounteID) values (71);
insert into Counter (CounteID) values (72);
insert into Counter (CounteID) values (73);
insert into Counter (CounteID) values (74);
insert into Counter (CounteID) values (75);
insert into Counter (CounteID) values (76);
insert into Counter (CounteID) values (77);
insert into Counter (CounteID) values (78);
insert into Counter (CounteID) values (79);
insert into Counter (CounteID) values (80);
insert into Counter (CounteID) values (81);
insert into Counter (CounteID) values (82);
insert into Counter (CounteID) values (83);
insert into Counter (CounteID) values (84);
insert into Counter (CounteID) values (85);
insert into Counter (CounteID) values (86);
insert into Counter (CounteID) values (87);
insert into Counter (CounteID) values (88);
insert into Counter (CounteID) values (89);
insert into Counter (CounteID) values (90);
insert into Counter (CounteID) values (91);
insert into Counter (CounteID) values (92);
insert into Counter (CounteID) values (93);
insert into Counter (CounteID) values (94);
insert into Counter (CounteID) values (95);
insert into Counter (CounteID) values (96);
insert into Counter (CounteID) values (97);
insert into Counter (CounteID) values (98);
insert into Counter (CounteID) values (99);
insert into Counter (CounteID) values (100);
...
/*
ID will be the BaseID.  Image URL will be local URL. Description will contain full description.
Alignment, Categories and Abilities will be stored in a separate table.
*/
...
insert into Staging_Characters (Base_ID, Name, Image, Power, Alignment, Categories, AbilityClasses, Role) 
values ('AAYLASECURA','Aayla Secura','tex.charui_aaylasecura.png',0,'Light Side', 'Galactic Republic, Jedi', 'Assist, Counter, Stun', 'Support');
...
insert into Staging_Characters (Base_ID, Name, Image, Power, Alignment) values ('CHIRRUTIMWE','Chirrut Œmwe','tex.charui_chirrut.png',0,'Light Side');
...
/*
This will contain Alignment Only.  LS, DS or Neutral


CREATE TABLE Alignment
	(
		AlignmId int AUTO_INCREMENT
		, AlignmName varchar(50)
		, AlignmDateCreated datetime
		, primary key (AlignmId)
	);
...
DROP VIEW IF EXISTS vw_Staging_Characters;
	

/*
View for Staging Characters.
Add Abilities, Roles, ETC
FIX ALIGNMENT
*/	
create view vw_Staging_Characters as

Select *
FROM Staging_Characters
	--inner join Alignment on Staging_Characters.Alignment = AlignmName;
...
DROP PROCEDURE IF EXISTS usp_DataMove_Characters;
DROP PROCEDURE IF EXISTS usp_DataMove_Alignment;
DROP PROCEDURE IF EXISTS usp_ForEachToon_Categories;
DROP PROCEDURE IF EXISTS usp_ForEachToon_AbilityClasses;
DROP PROCEDURE IF EXISTS usp_ForEachToon_Role;
DROP PROCEDURE IF EXISTS usp_AttributeList;
...
/*
This will move the Raw data from Staging_Characters Normalize the data, update / insert into Characters
*/
CREATE PROCEDURE usp_DataMove_Characters() NOT DETERMINISTIC READS SQL DATA SQL SECURITY DEFINER 

/*
Updates existing records to make sure they are up to date.
*/
update Characters
inner join Staging_Characters on CharacId = Base_ID
set CharacName = Name
	, CharacImageURL = Image
	, CharacPower = Power
	, CharacDescription = Description
	, CharacDateModified = Now();


/*
Inserts new records.
*/
insert into Characters (CharacId, CharacName, CharacImageURL, CharacPower, CharacDescription, CharacDateModified)
SELECT Base_ID, Name, Image, Power, Description, Now() 
FROM Staging_Characters
WHERE Base_ID not in (Select CharacID from Characters);




/*
This will move the Raw data from Staging_Characters Normalize the data, update / insert into Alignment.
Ru this before DataMove_Characters.
*/
CREATE PROCEDURE usp_DataMove_Alignment() NOT DETERMINISTIC READS SQL DATA SQL SECURITY DEFINER 

/*
insert into Alignment (AlignmName, AlignmDateCreated)
SELECT distinct Alignment,Now() 
FROM Staging_Characters 
where Alignment not in (select AlignmName from Alignment)
order by Alignment;
*/

	insert into Attributes (AttributeTypesAttTypId, AttribName)
	SELECT distinct 1, Alignment
	FROM Staging_Characters  
	where Alignment not in (select AttribName from Attributes where AttributeTypesAttTypId = 1)
	order by Alignment;
...
CREATE PROCEDURE usp_ForEachToon_Categories()  NOT DETERMINISTIC READS SQL DATA SQL SECURITY DEFINER 
BEGIN

	DECLARE cToon_UID VARCHAR(50) default '';
	DECLARE cCategories VARCHAR(255) default '';
	DECLARE Finished INTEGER DEFAULT 0;

DECLARE TableCursor Cursor for 
	SELECT Base_ID, Categories FROM `Staging_Characters` WHERE Base_ID = 'AAYLASECURA';
...
OPEN TableCursor;
  ...
  MainLoop: LOOP
    FETCH TableCursor INTO cToon_UID, cCategories;
    IF Finished THEN
      LEAVE MainLoop;
    END IF;

	
	CREATE TEMPORARY TABLE Toon_Categories
	SELECT cToon_UID
		, CounteId - LENGTH(REPLACE(LEFT(cCategories, CounteId-1), ',', '')) AS Pos
		, SUBSTRING(CONCAT(cCategories,','), CounteId, LOCATE(',', CONCAT(cCategories,','), CounteId)-CounteId) AS Value
	FROM Counter
	WHERE CounteId >0 AND CounteId<LENGTH(cCategories)+LENGTH(',') AND SubString(CONCAT(',',cCategories,','), CounteId, 1)=',';

	
	insert into Attributes (AttributeTypesAttTypId, AttribName)
	SELECT distinct 2, Value
	FROM Toon_Categories 
	where Value not in (select AttribName from Attributes where AttributeTypesAttTypId = 2)
	order by Value;
	
	
	DROP TEMPORARY TABLE Toon_Categories;
...
/*
Loop through AbilityClasses
*/
DELIMITER $$

CREATE PROCEDURE usp_ForEachToon_AbilityClasses()  NOT DETERMINISTIC READS SQL DATA SQL SECURITY DEFINER 
BEGIN

	DECLARE cToon_UID VARCHAR(50) default '';
	DECLARE cAbilityClasses VARCHAR(255) default '';
	DECLARE Finished INTEGER DEFAULT 0;

DECLARE TableCursor Cursor for 
	SELECT Base_ID, AbilityClasses FROM `Staging_Characters` WHERE Base_ID = 'AAYLASECURA';
...
OPEN TableCursor;
  ...
  MainLoop: LOOP
    FETCH TableCursor INTO cToon_UID, cAbilityClasses ;
    IF Finished THEN
      LEAVE MainLoop;
    END IF;
	...
	CREATE TEMPORARY TABLE Toon_Categories
	SELECT cToon_UID, CounteId - LENGTH(REPLACE(LEFT(cAbilityClasses, CounteId-1), ',', '')) AS Pos
		, SUBSTRING(CONCAT(cAbilityClasses,','), CounteId, LOCATE(',', CONCAT(cAbilityClasses,','), CounteId)-CounteId) AS Value
	FROM Counter
	WHERE CounteId >0 AND CounteId<LENGTH(cAbilityClasses)+LENGTH(',') AND SubString(CONCAT(',',cAbilityClasses,','), CounteId, 1)=',';

	
	insert into Attributes (AttributeTypesAttTypId, AttribName)
	SELECT distinct 3, Value
	FROM Toon_Categories 
	where Value not in (select AttribName from Attributes where AttributeTypesAttTypId = 3)
	order by Value;
...
CREATE PROCEDURE usp_ForEachToon_Role()  NOT DETERMINISTIC READS SQL DATA SQL SECURITY DEFINER 
BEGIN

	DECLARE cToon_UID VARCHAR(50) default '';
	DECLARE cRole VARCHAR(255) default '';
	DECLARE Finished INTEGER DEFAULT 0;

DECLARE TableCursor Cursor for 
	SELECT Base_ID, Role FROM `Staging_Characters` WHERE Base_ID = 'AAYLASECURA';
...
OPEN TableCursor;
  ...
  MainLoop: LOOP
    FETCH TableCursor INTO cToon_UID, cRole;
    IF Finished THEN
      LEAVE MainLoop;
    END IF;
	...
	CREATE TEMPORARY TABLE Toon_Categories
	SELECT cToon_UID, CounteId - LENGTH(REPLACE(LEFT(cRole, CounteId-1), ',', '')) AS Pos
		, SUBSTRING(CONCAT(cRole,','), CounteId, LOCATE(',', CONCAT(cRole,','), CounteId)-CounteId) AS Value
	FROM Counter
	WHERE CounteId >0 AND CounteId<LENGTH(cRole)+LENGTH(',') AND SubString(CONCAT(',',cRole,','), CounteId, 1)=',';


	insert into Attributes (AttributeTypesAttTypId, AttribName)
	SELECT distinct 4, Value
	FROM Toon_Categories 
	where Value not in (select AttribName from Attributes where AttributeTypesAttTypId = 4)
	order by Value;
 ...
 /*
 Attribute List for DDL
 */
 create procedure usp_AttributeList()  NOT DETERMINISTIC READS SQL DATA SQL SECURITY DEFINER 
 SELECT AttribId, AttribName FROM Attributes order by AttribName ;
...
CALL usp_DataMove_Alignment();
CALL usp_ForEachToon_Categories();
CALL usp_ForEachToon_AbilityClasses();
CALL usp_ForEachToon_Role();
CALL usp_AttributeList();
CALL usp_DataMove_Characters();
